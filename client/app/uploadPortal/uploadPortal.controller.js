...
.directive('contentItem', function ($compile, $http) {
    ...
    var articleTemplate = '<div><div class="post_div col-md-12"><div class="text_type_post" id="article"><a href="#"><span id="event_post_heading">{{content.articleId.articleName}}</span></a></br>{{content.articleId.content}}</br></br><div><p>by<a href="#"> {{content.uploader.user.name}}</a></p><span id="respond_post" ng-hide="liked" ng-click="like(content.articleId._id)"><a href="#"><img src="{{content.articleId.picUrl}}" width="20px" height="20px"> {{content.like.length}} Like</a></span><span id="respond_post" ng-show="liked" ng-click="unlike(content.articleId._id)"><a href="#"><img src="{{content.articleId.picUrl}}" width="20px" height="20px"> {{content.like.length}} Unlike</a></span></div></div><span id="post_time">{{content.articleId.createdOn}}</span></div></div>';
    var articleClubTemplate = '<div><div class="post_div col-md-12"><div class="text_type_post" id="article"><a href="#"><span id="event_post_heading">{{content.articleId.articleName}}</span></a></br>{{content.articleId.content}}</br></br><div><p>by<a href="#"> {{content.uploader.club.name}}</a></p><span id="respond_post" ng-hide="liked" ng-click="like(content.articleId._id)"><a href="#"><img src="{{content.articleId.picUrl}}" width="20px" height="20px"> {{content.like.length}} Like</a></span><span id="respond_post" ng-show="liked" ng-click="unlike(content.articleId._id)"><a href="#"><img src="{{content.articleId.picUrl}}" width="20px" height="20px"> {{content.like.length}} Unlike</a></span></div></div><span id="post_time">{{content.articleId.createdOn}}</span></div></div>';
